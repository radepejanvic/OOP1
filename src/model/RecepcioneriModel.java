...
public class RecepcioneriModel extends AbstractTableModel{
	...
	public RecepcioneriModel() throws IOException {
		this.km = KorisniciManager.getInstance();
	}

	@Override
	public int getRowCount() {
		return km.getRecepcioneri().size();
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Zaposleni z = km.getRecepcioneri().get(rowIndex);
		switch (columnIndex) {
		case 0:
