...
public class SobariceModel extends AbstractTableModel{
	...
	public SobariceModel() throws IOException {
		this.km = KorisniciManager.getInstance();
	}

	@Override
	public int getRowCount() {
		return km.getSobarice().size();
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		Zaposleni z = km.getSobarice().get(rowIndex);
		switch (columnIndex) {
		case 0:
